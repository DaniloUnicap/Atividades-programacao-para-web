...
function cadastrarAluno() {
  dados.question('Digite o nome do aluno: ', (nome) => {
...
function cadastrarNota(aluno) {
  dados.question(`Digite a nota ${aluno.notas.length + 1} do aluno ${aluno.nome}: `, (notaInput) => {
...
function menu() {
  ...
  console.log('4. Sair');
  dados.question('Escolha uma opção: ', (opcao) => {
    switch (opcao) {
      case '1':
        cadastrarAluno();
        break;
